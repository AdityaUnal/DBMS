...
class BPlusTree {
 ...
 public:
  ...
  auto AddAndSplit(page_id_t page_id, const KeyType &key) const -> KeyType;
  ...
  auto pessimist_latch_required(WritePageGuard& page_guard,std::vector<KeyType> &keys,std::vector<RID> &Rids) -> bool;
